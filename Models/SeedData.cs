                ...
                serviceProvider.GetRequiredService<DbContextOptions<Context>>()))
            {
                ...
                context.Recipes.AddRange(
                    ...
                    new Category 
                    {
                        Name = "Breakfast",
                        Recipes = new List<Recipe>{
                            new Recipe {Title = "Simple Overnight Oats", Description = "Stir it all together. In a small jar, stir together the oats, milk, yogurt, chia seeds, and maple syrup. - It’s soaking time. Place the jar in the fridge to let the oats soak for at least 2 hours, though overnight is best. - Add toppings and serve. The next morning, add your favorite toppings and enjoy! Alternatively, you can scoop the oats out into a bowl and add toppings from there."}
                            new Recipe {Title = "Avocado Toast", Description = "Toast your slice of bread until golden and firm. - Remove the pit from your avocado. Use a big spoon to scoop out the flesh. Put it in a bowl and mash it up with a fork until it’s as smooth as you like it. Mix in a pinch of salt (about ⅛ teaspoon) and add more to taste, if desired. - Spread avocado on top of your toast. Enjoy as-is or top with any extras offered in this post (I highly recommend a light sprinkle of flaky sea salt, if you have it)."},
